...
class MapARVC: UIViewController, ARSCNViewDelegate, CLLocationManagerDelegate, MKMapViewDelegate, UIGestureRecognizerDelegate {
...
//        }
    ...
    func setupGesture() {
        ...
        let longPressGesture = UILongPressGestureRecognizer(target: self, action: #selector(MapARVC.handleLongPress(gestureRecognizer:)))
...
extension MapARVC: HandleMapSearch {
